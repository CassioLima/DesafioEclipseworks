...
{
    public class TarefaAtualizarComand : Notifiable<Notification>, IRequest<CommandResult>
    {
        public TarefaAtualizarComand(int projetoId, int usuarioId, string titulo, string descricao, DateTime dataVencimento, Status status, Prioridade prioridade)
        {
            ProjetoId = projetoId;
            UsuarioId = usuarioId;
            Titulo = titulo;
            ...
            AddNotifications(new Contract<TarefaAtualizarComand>()
                .Requires()
