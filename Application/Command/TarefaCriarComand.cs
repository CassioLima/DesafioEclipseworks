...
{
    public class TarefaCriarComand : Notifiable<Notification>, IRequest<CommandResult>
    {
        public TarefaCriarComand(int projetoId, int usuarioId, string titulo, string descricao, DateTime dataVencimento, Status status, Prioridade prioridade)
        {
            ProjetoId = projetoId;
            UsuarioId = usuarioId;
            Titulo = titulo;
            ...
            AddNotifications(new Contract<TarefaCriarComand>()
                .Requires()
